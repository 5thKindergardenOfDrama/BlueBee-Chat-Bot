...
- τα μοντέλα εκπαιδεύονται στην πλατφόρμα προγραμματισμού, με κλήσεις στην πλατφόρμα της κοινότητας Τεχνητής Νοημοσύνης και Μηχανικής Μάθησης [Κaggle](https://www.kaggle.com/), χωρίς -χρονικούς και άλλους- περιορισμούς και
